...
class DatabaseManager:
    ...
    def insert_exam(self, exam_name, description=""):
        """Insert exam record returning integer exam_id"""
        query = """
...
def home():
    ...
    <body>
        <div class="container">
            ...
            <div class="endpoint">
                <h3><span class="method get">GET</span> /exam/<int:exam_id></h3>
                <p>Retrieve exam details and all questions</p>
            </div>
            
            <div class="endpoint">
                <h3><span class="method get">GET</span> /exam/<int:exam_id>/questions</h3>
        ...
        for attempt in range(max_retries):
            try:
                ...
                if is_valid_content and json_data:
                    ...
                    if save_to_db:
                        try:
                            # Create exam record (returns integer exam_id)
                            ...
                            enhanced_data["database"] = {
                                "saved": True,
                                "exam_id": exam_id,  # Integer exam_id
                                "exam_name": exam_name,
